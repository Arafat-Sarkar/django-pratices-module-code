...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        if not is_bankrupt:
            ...
            messages.error(
                self.request,
                f'Bank a not avabile avabile to money {"{:,.2f}".format(float(amount))}$ from your account'
            )
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            try:
                ...
                #     amount,
                #     'Transfer Message',
                #     'transactions/email_templates/transfer_email.html',
                ...
                #     amount,
                #     'Received Message',
                #     'transactions/email_templates/received_email.html',
                #     to_user.balance,
                # )
